Modified Apache CXF example
===========================

It is an example code for the following Stackoverflow question:
http://stackoverflow.com/questions/19721876/how-to-add-soap-security-header-usernametoken-information-to-code-first-webser

It shows how to configure Java-first service to include Username token policy in WSDL

This is modified CXF example that shows how to use disableCNCheck property. It is created 
to respond to the following question:
http://stackoverflow.com/questions/19448972/handshake-exception-in-java-webservice-client
